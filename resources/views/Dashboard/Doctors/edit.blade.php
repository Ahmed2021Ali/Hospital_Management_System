                ...
                <form action="{{ route('Doctor.update',$doctor->id) }}" method="post" autocomplete="off"
                    ...
                    <div class="pd-30 pd-sm-40 bg-gray-200">
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <input class="form-control" name="password" value="{{ $doctor->password }}" type="password">
                            </div>
                        </div>
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                <select name="section_id" class="form-control SlectBox">
                                    ...
                                    @foreach ($sections as $section)
                                        <option {{ $section->id == $doctor->section_id ? 'selected':''   }} value="{{ $section->id }}">{{ $section->name }}</option>
                                    @endforeach
                                </select>
                            </div>
...
{{--                                          @foreach ($appointments as $appointment )
                        ...
                        <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="col-md-11 mg-t-5 mg-md-t-0">
                                ...
                                <img  src="/images/doctors/{{ $doctor->image }}" style="border-radius:50%" width="150px" height="150px" id="output" />
                            </div>
                        </div>
