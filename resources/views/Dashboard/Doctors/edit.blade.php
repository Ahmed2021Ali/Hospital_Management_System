...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Doctor.update',$Doctor) }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div>
                                ...
                                @else
                                    <div class="text-center">
                                        <img style="border-radius:20%"
                                             src="\images\doctors\defoult.jpg"
                                             height="150px" width="150px" alt="">
                                    </div>
                                @endif
                            </div>
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select name="section_id" class="form-control SlectBox">
                                        ...
                                        @foreach ($sections as $section)
                                            <option
                                                {{ $section->id == $Doctor->section_id ? 'selected':''   }} value="{{ $section->id }}">{{ $section->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select multiple="multiple" class="testselect2" name="appointments[]">
                                        ...
                                        @foreach ($appointments as $appointment )
                                            <option
                                                value="{{ $appointment->id }}" {{in_array($appointment->name, explode(',' ,$Doctor->appointments)) ? 'selected' : '' }}>{{ $appointment->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    ...
                                    <img src="/images/doctors/{{ $Doctor->image }}" style="border-radius:50%"
                                         width="150px" height="150px" id="output"/>
                                </div>
                            </div>
