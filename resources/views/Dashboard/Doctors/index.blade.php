        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                        <a href="{{route('Doctor.create')}}" class="btn btn-primary" role="button" aria-pressed="true">{{trans('doctors.add_doctor')}}</a>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                          ...
                          @foreach($doctors as $doctor)
                              <tr>
                                  ...
                                  <td>
                                      @if($doctor->image)
                                          <img src="\images\doctors\{{ $doctor->image }}" height="50px" width="50px" alt="">
                                      @else
                                          <img src="\images\doctors\defoult.jpg" height="50px" width="50px" alt="">
                                      @endif
                                  </td>
                                  <td>{{ $doctor->name }}</td>
                                  <td>{{ $doctor->email }}</td>
                                  ...
                                  <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            <a class="dropdown-item" href="{{route('Doctor.edit',$doctor->id)}}"><i style="color: #0ba360" class="text-success ti-user"></i>&nbsp;&nbsp;تعديل البيانات</a>
